...
This directory holds contract artifacts for Agentcoder governance.
...
- Runtime-generated task/review/result contracts are written under `.runtime-cache/agentcoder/contracts/{tasks,reviews,results}`.
...
- Auto-generated coverage self-heal chains therefore land under `.runtime-cache/agentcoder/contracts/tasks`, even when their schema/source examples live in this directory.
...
- Adapter routing is additive; it does not replace Agentcoder primary orchestration.
