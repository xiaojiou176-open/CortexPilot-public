...
This directory holds contract artifacts for Codeflow governance.
...
- Runtime-generated task/review/result contracts are written under `.runtime-cache/codeflow/contracts/{tasks,reviews,results}`.
...
- Auto-generated coverage self-heal chains therefore land under `.runtime-cache/codeflow/contracts/tasks`, even when their schema/source examples live in this directory.
...
- Adapter routing is additive; it does not replace Codeflow primary orchestration.
