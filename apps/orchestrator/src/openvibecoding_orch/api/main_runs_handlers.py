...
from codeflow_orch.contract.role_config_registry import (
...
def build_runs_handlers(
    *,
    ...
    def get_operator_copilot_brief(run_id: str, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        from codeflow_orch.services.operator_copilot import generate_run_operator_copilot_brief
    ...
    def get_workflow_operator_copilot_brief(workflow_id: str, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        from codeflow_orch.services.operator_copilot import generate_workflow_operator_copilot_brief
