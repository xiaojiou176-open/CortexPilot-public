...
- `scripts/e2e_external_web_probe.py` now persists a stable hashed `run_id`
  reference in JSON status/report outputs instead of writing the original
  runtime identifier back to disk.
