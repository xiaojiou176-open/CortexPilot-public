...
from agentcoder_orch.contract.validator import ContractValidator, evaluate_superpowers_gate
from agentcoder_orch.scheduler import task_execution_pipeline
...
def _contract_base() -> dict[str, Any]:
    return {
        ...
        "allowed_paths": ["apps/orchestrator/src/agentcoder_orch/contract/validator.py"],
        "forbidden_actions": [],
