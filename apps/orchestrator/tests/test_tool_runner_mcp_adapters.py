...
def test_tool_runner_adapter_allowed_success(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("codeflow_orch.runners.tool_runner.mcp_adapter.record_mcp_call", _record)
    monkeypatch.setattr(
        "codeflow_orch.runners.tool_runner.execute_mcp_adapter",
...
def test_tool_runner_adapter_allowed_execution_failure(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("codeflow_orch.runners.tool_runner.mcp_adapter.record_mcp_call", lambda *_args, **_kwargs: None)
    monkeypatch.setattr(
        "codeflow_orch.runners.tool_runner.execute_mcp_adapter",
        lambda *_args, **_kwargs: {
            "ok": False,
