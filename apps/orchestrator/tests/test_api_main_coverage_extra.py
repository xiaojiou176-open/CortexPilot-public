...
def test_api_reject_service_run_not_found_maps_404(monkeypatch) -> None:
    ...
    resp = client.post("/api/runs/missing/reject", headers={"x-codeflow-role": "TECH_LEAD"})
