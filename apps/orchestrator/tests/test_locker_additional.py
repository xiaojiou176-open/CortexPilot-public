...
def test_lock_staleness_and_cleanup(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_RUN_ID", "run_active")
    ...
    monkeypatch.setenv("AGENTCODER_RUN_ID", "run_new")
...
def test_lock_ttl_and_non_cleanup_paths(tmp_path: Path, monkeypatch) -> None:
    runtime_root = tmp_path / "runtime"
    monkeypatch.setenv("AGENTCODER_RUNTIME_ROOT", str(runtime_root))
    monkeypatch.setenv("AGENTCODER_RUN_ID", "run_a")
    monkeypatch.delenv("AGENTCODER_LOCK_TTL_SEC", raising=False)
    monkeypatch.delenv("AGENTCODER_LOCK_TTL_SEC_DEFAULT", raising=False)
    ...
    monkeypatch.setenv("AGENTCODER_LOCK_TTL_SEC", "invalid")
    ...
    monkeypatch.setenv("AGENTCODER_RUN_ID", "run_b")
