...
def test_lock_staleness_and_cleanup(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("CODEFLOW_RUN_ID", "run_active")
    ...
    monkeypatch.setenv("CODEFLOW_RUN_ID", "run_new")
...
def test_lock_ttl_and_non_cleanup_paths(tmp_path: Path, monkeypatch) -> None:
    runtime_root = tmp_path / "runtime"
    monkeypatch.setenv("CODEFLOW_RUNTIME_ROOT", str(runtime_root))
    monkeypatch.setenv("CODEFLOW_RUN_ID", "run_a")
    monkeypatch.delenv("CODEFLOW_LOCK_TTL_SEC", raising=False)
    monkeypatch.delenv("CODEFLOW_LOCK_TTL_SEC_DEFAULT", raising=False)
    ...
    monkeypatch.setenv("CODEFLOW_LOCK_TTL_SEC", "invalid")
    ...
    monkeypatch.setenv("CODEFLOW_RUN_ID", "run_b")
