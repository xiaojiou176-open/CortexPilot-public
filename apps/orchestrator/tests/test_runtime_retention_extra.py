...
import agentcoder_orch.runtime.space_governance as space_governance_module
        ...
        "layers": {
            ...
            "repo_external_related": [
                ...
                },
                {
                    ...
                    "path": "${AGENTCODER_MACHINE_CACHE_ROOT}/pnpm-store/v10",
                    "type": "pnpm v10",
                ...
                },
                {
                    ...
                    "path": "${AGENTCODER_MACHINE_CACHE_ROOT}/pnpm-store/dashboard",
                    "type": "pnpm dashboard",
                ...
                },
                {
                    ...
                    "path": "${AGENTCODER_MACHINE_CACHE_ROOT}/playwright",
                ...
                },
                {
                    ...
                    "path": "${AGENTCODER_MACHINE_CACHE_ROOT}/toolchains/python/current",
...
def test_build_retention_plan_and_write_report_for_empty_roots(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_WORKTREE_ROOT", str(runtime_root / "worktrees"))
    monkeypatch.setenv("AGENTCODER_LOGS_ROOT", str(runtime_root / "logs"))
    monkeypatch.setenv("AGENTCODER_CACHE_ROOT", str(runtime_root / "cache"))
...
def test_machine_cache_retention_honors_policy_ttl_and_cap(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_RUNS_ROOT", str(runtime_root / "runs"))
    monkeypatch.setenv("AGENTCODER_WORKTREE_ROOT", str(runtime_root / "worktrees"))
    monkeypatch.setenv("AGENTCODER_LOGS_ROOT", str(repo_root / ".runtime-cache" / "logs"))
    monkeypatch.setenv("AGENTCODER_CACHE_ROOT", str(repo_root / ".runtime-cache" / "cache"))
    monkeypatch.setenv("AGENTCODER_MACHINE_CACHE_ROOT", str(machine_cache_root))
    monkeypatch.setenv("AGENTCODER_RETENTION_MACHINE_CACHE_CAP_BYTES", "200")
...
def test_machine_cache_retention_skips_entries_with_active_repo_scoped_processes(
    ...
    monkeypatch.setenv("AGENTCODER_CACHE_ROOT", str(repo_root / ".runtime-cache" / "cache"))
    monkeypatch.setenv("AGENTCODER_MACHINE_CACHE_ROOT", str(machine_cache_root))
    monkeypatch.setenv("AGENTCODER_RETENTION_MACHINE_CACHE_CAP_BYTES", "1024")
...
def test_config_fails_when_explicit_env_file_missing(monkeypatch) -> None:
    config_module._ENV_LOADED = False
    monkeypatch.setenv("AGENTCODER_ENV_FILE", "/tmp/agentcoder-env-file-should-not-exist.env")
