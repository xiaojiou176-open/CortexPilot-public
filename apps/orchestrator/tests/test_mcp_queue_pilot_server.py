...
from agentcoder_orch.mcp_queue_pilot_server import AgentcoderQueuePilotMcpServer
...
def test_mcp_queue_pilot_server_lists_tools_and_requires_confirm_for_apply(monkeypatch) -> None:
    ...
    server = AgentcoderQueuePilotMcpServer(
    ...
    monkeypatch.setenv("AGENTCODER_MCP_QUEUE_PILOT_ENABLE_APPLY", "1")
