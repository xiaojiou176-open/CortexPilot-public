...
def test_new_operator_report_and_task_pack_schemas_pass() -> None:
    ...
    control_plane_runtime_policy = {
        "version": "v1",
        "product_identity": {
            "title": "Agentcoder L0 Command Tower",
            "one_sentence": "Agentcoder is the command tower for AI engineering.",
...
def test_resolve_agent_registry_path_prefers_policies(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_AGENT_REGISTRY", "custom/agents.json")
