...
def test_resolve_roles_root_and_role_prompt_paths(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_SKIP_ROLE_PROMPT", "true")
    ...
    monkeypatch.setenv("AGENTCODER_SKIP_ROLE_PROMPT", "false")
...
def test_instruction_decoration_payload_and_prompts(tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setenv("AGENTCODER_INLINE_OUTPUT_SCHEMA", "false")
    ...
    monkeypatch.setenv("AGENTCODER_INLINE_OUTPUT_SCHEMA", "true")
    ...
    monkeypatch.setenv("AGENTCODER_CODEX_TIMEBOX_SEC", "120")
