...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "1",
            True,
            "env.CODEFLOW_LANGGRAPH_CONTRACT_SUBFLOW",
        ),
        (
            "env_disabled",
...
def test_contract_subflow_enable_disable_matrix(
    ...
    if env_flag is None:
        monkeypatch.delenv("CODEFLOW_LANGGRAPH_CONTRACT_SUBFLOW", raising=False)
    else:
        monkeypatch.setenv("CODEFLOW_LANGGRAPH_CONTRACT_SUBFLOW", env_flag)
