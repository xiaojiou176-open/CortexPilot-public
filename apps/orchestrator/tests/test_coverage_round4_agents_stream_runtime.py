...
from codeflow_orch.runners import agents_stream_runtime
...
def test_stream_runtime_invalid_timeout_inputs_are_fail_closed(
    ...
    monkeypatch.setenv("CODEFLOW_STREAM_IDLE_TIMEOUT_SEC", "oops")
    monkeypatch.setenv("CODEFLOW_CODEX_TIMEBOX_SEC", "oops")
...
def test_stream_runtime_non_positive_idle_and_hard_timebox_values(
    ...
    monkeypatch.setattr(agents_stream_runtime, "cancel_watch_tasks", lambda *args: None)
    monkeypatch.setenv("CODEFLOW_STREAM_IDLE_TIMEOUT_SEC", "0")
    monkeypatch.setenv("CODEFLOW_CODEX_TIMEBOX_SEC", "-1")
...
def test_stream_runtime_hard_timebox_only_applies_and_completes(
    ...
    monkeypatch.delenv("CODEFLOW_STREAM_IDLE_TIMEOUT_SEC", raising=False)
...
def test_stream_runtime_broken_pipe_and_idle_timeout_events(
    ...
    monkeypatch.setenv("CODEFLOW_STREAM_IDLE_TIMEOUT_SEC", "0.1")
