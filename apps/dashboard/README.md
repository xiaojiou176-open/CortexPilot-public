...
- the browser-based command tower for plan, delegate, track, resume, and prove
  loops
- a way to inspect and operate Agentcoder Command Tower orchestration truth from the web
...
- Provide run, workflow, session, and review visualization for Agentcoder Command Tower
