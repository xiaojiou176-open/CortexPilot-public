...
import { UI_LOCALE_STORAGE_KEY } from "@codeflow/frontend-shared/uiLocale";
...
describe("DashboardShellChrome", () => {
  ...
  it("renders landing chrome with compact nav and landing brand", () => {
    ...
    expect(screen.getByRole("link", { name: "Codeflow" })).toHaveTextContent("OVC");
  ...
  it("renders non-landing chrome with live badges and full brand", () => {
    ...
    expect(screen.getByRole("link", { name: "Codeflow" })).toHaveTextContent("Codeflow");
