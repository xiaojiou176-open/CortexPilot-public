...
export { knownOutcomeTypeLabelZh, outcomeTypeLabelZh } from "@codeflow/frontend-shared/statusPresentation";
export type { UiLocale } from "@codeflow/frontend-shared/statusPresentation";
