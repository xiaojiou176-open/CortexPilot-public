...
description: Teach the agent how to connect the current live public package for the Codeflow read-only MCP, choose the right public lane, and use the stable read-only tools without overclaiming hosted or write-capable support.
triggers:
  - codeflow
  - codeflow setup
  - codeflow mcp
...
Use this skill when the user needs the shortest truthful path into Codeflow.

## What this skill teaches

- how to install the current live public package for the Codeflow read-only MCP
...
- connect Codeflow to OpenHands or OpenClaw
- inspect runs or workflows through the public read-only MCP
- understand which public Codeflow lane to choose first
