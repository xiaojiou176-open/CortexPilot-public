...
export declare const FRONTEND_API_CONTRACT: {
  ...
  readonly envKeys: readonly [
    "NEXT_PUBLIC_CODEFLOW_API_BASE", "NEXT_PUBLIC_CODEFLOW_API_BASE", "VITE_CODEFLOW_API_BASE", "VITE_CODEFLOW_API_BASE", "CODEFLOW_API_BASE", "CODEFLOW_API_BASE"
  ];
  readonly headers: {
    readonly requestId: "x-request-id";
    readonly traceId: "x-trace-id";
    readonly traceparent: "traceparent";
    readonly runId: "x-codeflow-run-id";
  };
  readonly network: {
  ...
  readonly readModels: {
    ...
    readonly runtimeBindingSourceModels: readonly ["env.CODEFLOW_CODEX_MODEL", "env.CODEFLOW_PROVIDER_MODEL", "role_contract.runtime_binding.model", "unresolved"];
...
export type RuntimeBindingSourceModel = "env.CODEFLOW_CODEX_MODEL" | "env.CODEFLOW_PROVIDER_MODEL" | "role_contract.runtime_binding.model" | "unresolved";
