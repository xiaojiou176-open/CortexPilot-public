...
`@codeflow/frontend-api-contract` is the repo-owned contract package for
frontend-safe Codeflow route names, query shapes, and generated types.
...
- a stable contract layer below `@codeflow/frontend-api-client`
...
1. Start with the public [compatibility matrix](https://xiaojiou176-open.github.io/codeflow/compatibility/) when your team still needs the shortest “which adoption ladder fits us?” answer.
2. Continue to the public [agent starter kits](https://xiaojiou176-open.github.io/codeflow/agent-starters/) when your next move is wiring a real Codex / Claude Code / OpenClaw config instead of only reading the route map.
3. Continue to the public [API quickstart](https://xiaojiou176-open.github.io/codeflow/api/) when you want the human-readable HTTP boundary.
4. Continue to the public [builder quickstart](https://xiaojiou176-open.github.io/codeflow/builders/) when you want the package map.
5. Import `@codeflow/frontend-api-contract` when you are working inside the same repo or a vendored workspace copy and need generated route/query/type truth without backend imports.
...
Then keep the Codeflow package story honest:
...
- it does not turn Codeflow into an official plugin, marketplace artifact,
  or hosted SDK
...
- pair it with `@codeflow/frontend-api-client` when you want a runnable
