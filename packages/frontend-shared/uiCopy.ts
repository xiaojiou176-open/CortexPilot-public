  ...
  en: {
    ...
    dashboard: {
      homePhase2: {
        ...
        heroSubtitle:
          "Stop babysitting AI coding work. AI coding does not lack models. It lacks a command tower. Codeflow gives teams one governed operator path to plan, delegate, track, resume, and prove long-running engineering work across Codex and Claude Code.",
        ...
        publicTemplatesTitle: "One proven workflow, two release-proven secondary paths",
        publicTemplatesDescription:
          "Start with `news_digest` first. It is the official public baseline. `topic_brief` and `page_brief` now follow release-proven secondary paths, but `news_digest` remains the only official first public baseline.",
        ...
        publicTemplateCards: [
          ...
          },
          {
            ...
            badge: "Release-proven secondary path",
            title: "topic_brief",
            ...
            proof: "Proof state: release-proven secondary search-backed path",
          ...
          },
          {
            ...
            proof: "Proof state: release-proven secondary browser-backed path",
            fields: ["url", "focus"],
          },
        ],
        publicAdvantagesTitle: "Three engineering layers behind the command tower",
        publicAdvantagesDescription:
          "Codeflow is not just one more prompt wrapper. It turns prompt, context, and harness decisions into explicit product surfaces so long-running work keeps moving when humans step away.",
        ...
        ecosystemCards: [
          {
            ...
            desc: "Use Codeflow when Codex-driven work needs one command tower, one case record, and one replayable proof path.",
            href: "/command-tower",
            prefetch: true,
          },
          {
        ...
        aiSurfacesDescription:
          "AI in Codeflow is not a floating chat box. It already shows up as a pre-run advisor, a workflow-level explainer, and a run/compare operator brief.",
        ...
        builderCards: [
          ...
          },
          {
            ...
            title: "@codeflow/frontend-api-client",
            ...
            href: "https://github.com/xiaojiou176-open/codeflow/blob/main/packages/frontend-api-client/README.md",
          },
          {
            badge: "Contract-facing",
            title: "@codeflow/frontend-api-contract",
            ...
            href: "https://github.com/xiaojiou176-open/codeflow/blob/main/packages/frontend-api-contract/docs/README.md",
          },
          {
            badge: "Presentation substrate",
            title: "@codeflow/frontend-shared",
            ...
            href: "https://github.com/xiaojiou176-open/codeflow/blob/main/packages/frontend-shared/README.md",
          },
        ],
      ...
      topbarTitle: "Codeflow command tower",
      ...
      commandTowerPage: {
        ...
        liveHome: {
          ...
          drawer: {
            projectKeyPlaceholder: "e.g. codeflow",
    ...
    desktop: {
      ...
      shellAriaLabel: "Codeflow command tower desktop shell",
      ...
      commandTower: {
        title: "Command Tower",
        subtitle: "Codeflow on desktop stays focused on execution and operator decisions; deeper governance analysis still moves to the web view.",
      ...
      overview: {
        ...
        subtitle:
          "Codeflow starts with one loop: start the task, watch Command Tower, confirm the Workflow Case, then verify Proof & Replay. Only open approvals when the flow asks for one.",
        refreshData: "Refresh data",
  ...
  "zh-CN": {
    ...
    dashboard: {
      homePhase2: {
        ...
        heroSubtitle:
          "别再盯着 AI 编码一步一步催了。AI 编码不缺模型，缺的是指挥塔。Codeflow 会围绕 Codex / Claude Code 去规划、派工、追踪、续跑和验真，把长期工程任务收进一条可治理、可续跑、可验真的操作路径。",
        ...
        publicTemplatesTitle: "一个已证明工作流，两条已发布验证的次级路径",
        publicTemplatesDescription:
          "先从 `news_digest` 开始。它是官方公开基线。`topic_brief` 和 `page_brief` 现在都属于已发布验证的次级路径，但 `news_digest` 仍是唯一官方第一公开基线。",
        ...
        publicTemplateCards: [
          ...
          },
          {
            ...
            example: "https://example.com + focused summary request",
            proof: "证明状态：已发布验证的浏览器次级路径",
            fields: ["url", "focus"],
          },
        ],
        publicAdvantagesTitle: "指挥塔背后的三层工程能力",
        publicAdvantagesDescription:
          "Codeflow 不是再包一层花哨提示词，而是把提示词、上下文和护栏这三类最容易失控的东西，都拉进显式、可检查、可演进的系统里。",
        publicAdvantageCards: [
          {
            href: "/pm",
            title: "提示词工程",
        ...
        ecosystemCards: [
          {
            badge: "主工作流绑定",
            title: "Codex 工作流",
            desc: "当 Codex 驱动的工作需要统一指挥塔、案例记录和可回放证明路径时，就该由 Codeflow 承接。",
            href: "/command-tower",
            prefetch: true,
          },
          {
        ...
        aiSurfacesDescription:
          "Codeflow 里的 AI 不是漂浮聊天框。它已经分别出现在执行前建议、工作流解释，以及运行/对比的操作摘要里。",
      ...
      commandTowerPage: {
        ...
        liveHome: {
          ...
          drawer: {
            projectKeyPlaceholder: "例如 codeflow",
    ...
    desktop: {
      ...
      shellAriaLabel: "Codeflow 指挥塔桌面端",
      ...
      commandTower: {
        title: "指挥塔",
        subtitle: "Codeflow 的桌面端聚焦执行与操作决策；更深的治理分析仍留给 Web 视图。",
      ...
      overview: {
        title: "指挥面总览",
        subtitle:
          "Codeflow 的第一条主循环是：发起任务、观察指挥塔、确认工作流案例、再检查证明与回放。只有在流程要求时才进入审批。",
        refreshData: "刷新数据",
