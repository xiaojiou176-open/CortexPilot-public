...
export type UiCopy = {
  ...
  dashboard: {
    homePhase2: {
      ...
      caseGalleryBaselineTitle: string;
      caseGalleryBaselineDescription: string;
      caseGalleryBaselineCards: HomeCaseGalleryCardCopy[];
