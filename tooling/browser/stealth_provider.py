...
class StealthProvider:
    ...
    def from_policy(cls, policy: dict[str, Any] | None) -> "StealthProvider":
        ...
        if not isinstance(plugin_optional, bool):
            plugin_optional = _to_bool(os.getenv("AGENTCODER_BROWSER_PLUGIN_OPTIONAL", ""), True)
    ...
    def from_env(
        ...
        raw_mode = _first_non_empty(
            ...
            os.getenv("AGENTCODER_WEB_STEALTH_MODE"),
        ) or "none"
        raw_optional = _first_non_empty(os.getenv("AGENTCODER_BROWSER_PLUGIN_OPTIONAL"))
