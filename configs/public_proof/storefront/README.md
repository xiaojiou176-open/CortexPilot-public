...
- `agentcoder-command-tower-teaser-poster.png`: poster frame for the short promo teaser
- `agentcoder-command-tower-teaser.mp4`: tracked short promo teaser for README / Pages front door
- `agentcoder-command-tower-teaser.vtt`: tracked English captions for the teaser
...
- treat `agentcoder-command-tower-teaser.mp4` as a public-facing promo asset, not as proof of hosted production scale or broader workflow coverage
