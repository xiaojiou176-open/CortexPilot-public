...
- `configs/public_proof/releases_assets/page-brief-healthy-proof-summary-2026-04-15.json`
- `configs/public_proof/releases_assets/page-brief-benchmark-summary-2026-04-15.md`
- `configs/public_proof/releases_assets/page-brief-benchmark-summary-2026-04-15.json`
...
- `page_brief` is not the official first public baseline today.
- `page_brief` is not equally release-proven as `news_digest`.
- this bundle does not prove hosted production readiness or a public
