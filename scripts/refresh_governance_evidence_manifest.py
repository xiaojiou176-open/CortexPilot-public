...
UPSTREAM_RECORD_FRESH_SEC = int(os.environ.get("CODEFLOW_UPSTREAM_RECORD_FRESH_SEC", "1800"))
CHECK_OUTPUT_MAX_CHARS = int(os.environ.get("CODEFLOW_GOVERNANCE_CHECK_OUTPUT_MAX_CHARS", "12000"))
...
CHECKS = {
    ...
    "cache": [
        ...
        },
        {
            ...
            "artifacts": [".runtime-cache/codeflow/reports/retention_report.json"],
        },
        {"id": "cleanup_demoted", "weight": 2, "command": ["bash", "-lc", "CODEFLOW_HYGIENE_SKIP_UPSTREAM=1 bash scripts/check_repo_hygiene.sh"]},
    ],
    "logging": [
        {
        ...
        },
        {
            ...
            "command": [
                "bash",
                "-lc",
                "source scripts/lib/env.sh && PYTHONPATH=apps/orchestrator/src ${CODEFLOW_PYTHON:-python3} -m pytest apps/orchestrator/tests/test_observability_logger.py -q",
            ],
        },
        {
    ...
    "root_cleanliness": [
        ...
        {"id": "hygiene_gate", "weight": 3, "command": ["bash", "-lc", "CODEFLOW_HYGIENE_SKIP_UPSTREAM=1 bash scripts/check_repo_hygiene.sh"]},
    ],
    "upstream": [
        {
        ...
        {"id": "supply_chain", "weight": 2, "command": ["python3", "scripts/check_ci_supply_chain_policy.py"]},
        {
            ...
            "command": [
                ...
                "-c",
                (
                    "from pathlib import Path; text=Path('apps/orchestrator/src/codeflow_orch/runners/provider_resolution.py')"
...
def _current_ci_route_id() -> str:
    return str(os.environ.get("CODEFLOW_CI_ROUTE_ID") or "").strip()
