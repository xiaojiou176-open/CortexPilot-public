...
MODE="${CODEFLOW_UI_PROTOCOL_MODE:-gate}"
if [[ "${1:-}" == "--mode" ]]; then
  MODE="${2:-}"
  shift 2
fi
...
FAIL_ON_WARN="${CODEFLOW_UI_PROTOCOL_FAIL_ON_WARN:-0}"
ALLOWLIST_PATH="${CODEFLOW_UI_PROTOCOL_ALLOWLIST:-configs/ui_protocol_allowlist.json}"
