...
FORBIDDEN_PATTERNS = (
    ...
    ("legacy_runtime_contract_root", re.compile(r"(?<!\.runtime-cache/)agentcoder/contracts/")),
...
FORBIDDEN_ROOTS = ("config", "out", "agentcoder", "codex", LEGACY_VENV_SEGMENT, LEGACY_CARGO_SEGMENT)
