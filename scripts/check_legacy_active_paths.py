...
FORBIDDEN_PATTERNS = (
    ...
    ("legacy_runtime_contract_root", re.compile(r"(?<!\.runtime-cache/)codeflow/contracts/")),
...
FORBIDDEN_ROOTS = ("config", "out", "codeflow", "codex", LEGACY_VENV_SEGMENT, LEGACY_CARGO_SEGMENT)
