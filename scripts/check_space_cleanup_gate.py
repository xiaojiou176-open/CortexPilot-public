...
DEFAULT_REPORT_JSON = ROOT / ".runtime-cache" / "codeflow" / "reports" / "space_governance" / "report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate the Codeflow disk-space cleanup preflight gate.")
