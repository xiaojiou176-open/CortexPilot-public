...
DEFAULT_REPORT_JSON = ROOT / ".runtime-cache" / "agentcoder" / "reports" / "space_governance" / "report.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate the Agentcoder disk-space cleanup preflight gate.")
