...
CURRENT_RUN_ROOT=".runtime-cache/codeflow/reports/ci/current_run"
CURRENT_RUN_ROUTE_REPORT=".runtime-cache/codeflow/reports/ci/routes/local-advisory.json"
...
manifest = Path(".runtime-cache/codeflow/reports/ci/current_run/source_manifest.json")
consistency = Path(".runtime-cache/codeflow/reports/ci/current_run/consistency.json")
...
CODEFLOW_HYGIENE_SKIP_UPSTREAM=1 bash scripts/check_repo_hygiene.sh
echo
...
echo "   current-run truth: .runtime-cache/codeflow/reports/ci/current_run/consistency.json"
