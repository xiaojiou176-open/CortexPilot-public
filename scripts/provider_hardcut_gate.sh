...
PYTHON_BIN="${CODEFLOW_PROVIDER_HARDCUT_PYTHON_BIN:-}"
...
check_provider_env_var "CODEFLOW_E2E_CODEX_PROVIDER"
check_provider_env_var "CODEFLOW_CI_PM_CHAT_PROVIDER"
check_provider_env_var "CODEFLOW_CI_PM_CHAT_RUNTIME_OPTIONS_PROVIDER"
check_provider_env_var "CODEFLOW_CI_DEFAULT_PROVIDER"
check_provider_env_var "CODEFLOW_MODEL_PROVIDER"
check_provider_env_var "PM_CHAT_CODEX_PROVIDER"
check_provider_env_var "PM_CHAT_RUNTIME_OPTIONS_PROVIDER"
check_provider_env_var "CODEFLOW_RUNTIME_OPTIONS_PROVIDER"
check_provider_env_var "CODEFLOW_PROVIDER"

check_base_url_env_var "CODEFLOW_E2E_CODEX_BASE_URL"
check_base_url_env_var "CODEFLOW_CI_PM_CHAT_BASE_URL"
check_base_url_env_var "CODEFLOW_CI_DEFAULT_BASE_URL"
check_base_url_env_var "CODEFLOW_MODEL_BASE_URL"
check_base_url_env_var "PM_CHAT_CODEX_BASE_URL"

check_model_env_var "CODEFLOW_E2E_CODEX_MODEL"
check_model_env_var "CODEFLOW_CI_PM_CHAT_MODEL"
check_model_env_var "CODEFLOW_CI_DEFAULT_MODEL"
check_model_env_var "CODEFLOW_MODEL_NAME"
check_model_env_var "CODEFLOW_MODEL"
check_model_env_var "PM_CHAT_CODEX_MODEL"

if [[ "${CODEFLOW_PROVIDER_HARDCUT_SKIP_CODEX_CONFIG:-0}" != "1" ]] && [[ -n "$PYTHON_BIN" ]] && [[ -f "$codex_config_path" ]]; then
