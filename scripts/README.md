...
- `e2e_external_web_probe.py` persists hashed run references in its JSON status
  and report artifacts so probe receipts stay correlatable without storing the
  original runtime identifier verbatim.
