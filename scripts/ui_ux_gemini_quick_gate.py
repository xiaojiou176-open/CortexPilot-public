...
KEY_ENV_SELECTOR = "CODEFLOW_UI_GEMINI_KEY_ENV"
KEY_ENV_DEFAULT = "GEMINI_API_KEY"
MODEL_ENV = "CODEFLOW_UI_GEMINI_MODEL"
REQUEST_TIMEOUT_ENV = "CODEFLOW_UI_GEMINI_TIMEOUT_SEC"
...
def _prepush_ui_files() -> list[str]:
    ...
    Optional override: CODEFLOW_UI_GEMINI_QUICK_SCOPE=upstream_range.
    """
    scope = (os.environ.get("CODEFLOW_UI_GEMINI_QUICK_SCOPE", "head_commit") or "head_commit").strip().lower()
    candidates: list[str] = []
...
def _build_prompt(file_payload: list[dict[str, Any]]) -> str:
    ...
    return (
        "You are a strict UI/UX gate reviewer for Codeflow frontend code. "
