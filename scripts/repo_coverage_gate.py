...
DEFAULT_THRESHOLD = float(os.environ.get("AGENTCODER_REPO_COVERAGE_GATE_THRESHOLD", "95"))
...
def run_dashboard_coverage(report_path: Path, test_targets: list[str]) -> None:
    ...
    run_command(
        ...
        env_overrides={
            "CI": "1",
            "AGENTCODER_COVERAGE_HTML": "0",
            "AGENTCODER_DASHBOARD_COVERAGE_DIR": str(report_path.parent),
        },
    )
...
def run_desktop_coverage(report_path: Path, test_targets: list[str]) -> None:
    ...
    run_command(
        ...
        env_overrides={
            "CI": "1",
            "AGENTCODER_COVERAGE_HTML": "0",
            "AGENTCODER_DESKTOP_COVERAGE_DIR": str(report_path.parent),
            "AGENTCODER_DESKTOP_COVERAGE_RUN_ID": "repo-coverage-gate",
        },
    )
