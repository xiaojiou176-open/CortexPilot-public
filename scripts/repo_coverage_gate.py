...
DEFAULT_THRESHOLD = float(os.environ.get("CODEFLOW_REPO_COVERAGE_GATE_THRESHOLD", "95"))
...
def run_dashboard_coverage(report_path: Path, test_targets: list[str]) -> None:
    ...
    run_command(
        ...
        env_overrides={
            "CI": "1",
            "CODEFLOW_COVERAGE_HTML": "0",
            "CODEFLOW_DASHBOARD_COVERAGE_DIR": str(report_path.parent),
        },
    )
...
def run_desktop_coverage(report_path: Path, test_targets: list[str]) -> None:
    ...
    run_command(
        ...
        env_overrides={
            "CI": "1",
            "CODEFLOW_COVERAGE_HTML": "0",
            "CODEFLOW_DESKTOP_COVERAGE_DIR": str(report_path.parent),
            "CODEFLOW_DESKTOP_COVERAGE_RUN_ID": "repo-coverage-gate",
        },
    )
