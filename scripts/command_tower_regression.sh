...

{
  ...
  echo
  echo "## Commands"
  echo "1. \\`PYTHONPATH=apps/orchestrator/src \${CODEFLOW_PYTHON:-.runtime-cache/cache/toolchains/python/current/bin/python} -m pytest apps/orchestrator/tests/test_api_main.py -q\\`"
