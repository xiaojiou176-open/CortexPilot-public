...
APP_PATH="${DESKTOP_NOTARY_APP_PATH:-$BUNDLE_DIR/macos/Agentcoder Desktop.app}"
DMG_PATH="${DESKTOP_NOTARY_DMG_PATH:-$BUNDLE_DIR/dmg/Agentcoder Desktop_0.1.0_aarch64.dmg}"
