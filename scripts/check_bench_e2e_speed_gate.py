...
DEFAULT_MAX_FAIL_RATE = float(os.environ.get("CODEFLOW_BENCH_MAX_FAIL_RATE", "0.05"))
DEFAULT_UI_MAX_P95_SEC = float(os.environ.get("CODEFLOW_BENCH_UI_FULL_GEMINI_STRICT_MAX_P95_SEC", "180"))
DEFAULT_DASH_MAX_P95_SEC = float(os.environ.get("CODEFLOW_BENCH_DASHBOARD_HIGH_RISK_E2E_MAX_P95_SEC", "90"))
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Maximum allowed overall fail_rate (default from CODEFLOW_BENCH_MAX_FAIL_RATE or 0.05).",
    )
    parser.add_argument(
        "--ui-max-p95-sec",
        type=float,
