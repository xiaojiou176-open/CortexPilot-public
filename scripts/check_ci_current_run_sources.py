...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-json", default=".runtime-cache/codeflow/reports/ci/current_run/consistency.json")
    parser.add_argument("--out-markdown", default=".runtime-cache/codeflow/reports/ci/current_run/consistency.md")
...
def main() -> int:
    ...
    try:
        ...
        payload = {
            "report_type": "codeflow_ci_current_run_consistency",
