...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-json", default=".runtime-cache/agentcoder/reports/ci/current_run/consistency.json")
    parser.add_argument("--out-markdown", default=".runtime-cache/agentcoder/reports/ci/current_run/consistency.md")
...
def main() -> int:
    ...
    try:
        ...
        payload = {
            "report_type": "agentcoder_ci_current_run_consistency",
