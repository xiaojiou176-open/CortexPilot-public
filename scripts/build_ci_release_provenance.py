...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--image", default=os.environ.get("AGENTCODER_CI_PROVENANCE_IMAGE", "agentcoder-ci-core:local"))
    parser.add_argument("--strict", action="store_true")
    parser.add_argument("--out-dir", default=".runtime-cache/agentcoder/release/provenance")
...
def main() -> int:
    ...
    payload = {
        "report_type": "agentcoder_ci_release_provenance",
        ...
        **authority,
        ...
        "image": {
            ...
            "input_hash": ((inspect.get("Config") or {}).get("Labels") or {}).get("org.agentcoder.ci.input-hash", ""),
        },
