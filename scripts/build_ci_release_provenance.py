...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--image", default=os.environ.get("CODEFLOW_CI_PROVENANCE_IMAGE", "codeflow-ci-core:local"))
    parser.add_argument("--strict", action="store_true")
    parser.add_argument("--out-dir", default=".runtime-cache/codeflow/release/provenance")
...
def main() -> int:
    ...
    payload = {
        "report_type": "codeflow_ci_release_provenance",
        ...
        **authority,
        ...
        "image": {
            ...
            "input_hash": ((inspect.get("Config") or {}).get("Labels") or {}).get("org.codeflow.ci.input-hash", ""),
        },
