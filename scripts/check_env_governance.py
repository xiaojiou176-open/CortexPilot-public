...
SCAN_ROOTS = (
    "apps/orchestrator/src/codeflow_orch",
    "apps/dashboard",
    "apps/desktop",
    "scripts",
    "tools",
...
ENV_KEY_ALLOW_PATTERN = re.compile(
    r"^(CODEFLOW_|OPENAI_|NEXT_PUBLIC_|VITE_|GEMINI_|DASHBOARD_VITEST_|DESKTOP_VITEST_|VITEST_|CI$|NODE_ENV$)"
)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Codeflow env governance checker")
