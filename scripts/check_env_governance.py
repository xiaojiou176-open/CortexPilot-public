...
SCAN_ROOTS = (
    "apps/orchestrator/src/agentcoder_orch",
    "apps/dashboard",
    "apps/desktop",
    "scripts",
    "tools",
...
ENV_KEY_ALLOW_PATTERN = re.compile(
    r"^(AGENTCODER_|OPENAI_|NEXT_PUBLIC_|VITE_|GEMINI_|DASHBOARD_VITEST_|DESKTOP_VITEST_|VITEST_|CI$|NODE_ENV$)"
)
...
LEGACY_LLM_KEYS = (
    "OPENAI_API_KEY",
    "AGENTCODER_EQUILIBRIUM_API_KEY",
)
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Agentcoder env governance checker")
