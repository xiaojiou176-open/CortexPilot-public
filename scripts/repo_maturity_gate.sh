...
dimensions = [
    ...
    build_dimension(
        ...
        [
            ...
            Check("truth_strict_default", 2, has(ci_combined_text, 'AGENTCODER_UI_TRUTH_GATE_STRICT="${AGENTCODER_CI_UI_TRUTH_GATE_STRICT:-1}"'), "AGENTCODER_CI_UI_TRUTH_GATE_STRICT default=1"),
        ],
    ),
    build_dimension(
        ...
        [
            Check("strict_click_switch", 2, has(ci_combined_text, "AGENTCODER_CI_UI_STRICT_CLICK_GATE"), "AGENTCODER_CI_UI_STRICT_CLICK_GATE"),
            ...
            Check("click_inventory_required", 3, has(ci_combined_text, "AGENTCODER_UI_CLICK_INVENTORY_REQUIRED"), "AGENTCODER_UI_CLICK_INVENTORY_REQUIRED"),
            Check(
...
redlines = [
    {
        ...
        and has(ci_combined_text, "AGENTCODER_UI_CLICK_INVENTORY_REQUIRED")
    ...
    },
    {
        ...
        "passed": has(ci_combined_text, 'AGENTCODER_UI_TRUTH_GATE_STRICT="${AGENTCODER_CI_UI_TRUTH_GATE_STRICT:-1}"'),
