...
dimensions = [
    ...
    build_dimension(
        ...
        [
            ...
            Check("truth_strict_default", 2, has(ci_combined_text, 'CODEFLOW_UI_TRUTH_GATE_STRICT="${CODEFLOW_CI_UI_TRUTH_GATE_STRICT:-1}"'), "CODEFLOW_CI_UI_TRUTH_GATE_STRICT default=1"),
        ],
    ),
    build_dimension(
        ...
        [
            Check("strict_click_switch", 2, has(ci_combined_text, "CODEFLOW_CI_UI_STRICT_CLICK_GATE"), "CODEFLOW_CI_UI_STRICT_CLICK_GATE"),
            ...
            Check("click_inventory_required", 3, has(ci_combined_text, "CODEFLOW_UI_CLICK_INVENTORY_REQUIRED"), "CODEFLOW_UI_CLICK_INVENTORY_REQUIRED"),
            Check(
...
redlines = [
    {
        ...
        and has(ci_combined_text, "CODEFLOW_UI_CLICK_INVENTORY_REQUIRED")
    ...
    },
    {
        ...
        "passed": has(ci_combined_text, 'CODEFLOW_UI_TRUTH_GATE_STRICT="${CODEFLOW_CI_UI_TRUTH_GATE_STRICT:-1}"'),
