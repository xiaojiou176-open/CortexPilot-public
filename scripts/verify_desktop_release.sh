...
APP_PATH="${DESKTOP_VERIFY_APP_PATH:-$BUNDLE_DIR/macos/Codeflow Desktop.app}"
DMG_PATH="${DESKTOP_VERIFY_DMG_PATH:-$BUNDLE_DIR/dmg/Codeflow Desktop_0.1.0_aarch64.dmg}"
ICON_REQUIRED=(
