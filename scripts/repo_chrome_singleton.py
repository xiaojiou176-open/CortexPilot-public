...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Manage the Codeflow repo-owned Chrome singleton root and CDP instance."
    )
    ...
    migrate.add_argument("--source-profile-name", default="codeflow")
    ...
    migrate.add_argument("--target-display-name", default="codeflow")
    ...
    launch.add_argument("--profile-name", default="codeflow")
    ...
    status.add_argument("--profile-name", default="codeflow")
