...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Manage the Agentcoder repo-owned Chrome singleton root and CDP instance."
    )
    ...
    migrate.add_argument("--source-profile-name", default="agentcoder")
    ...
    migrate.add_argument("--target-display-name", default="agentcoder")
    ...
    launch.add_argument("--profile-name", default="agentcoder")
    ...
    status.add_argument("--profile-name", default="agentcoder")
