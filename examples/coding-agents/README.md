...
local plugin-bundle installation that ships CortexPilot skills.
...
Use `claude-code/` when you want a project-local `.claude` starter instead of
inventing a fake marketplace story.
...
example. Start with `openclaw/README.md`.
