...
This folder shows a truthful Codeflow starter for Claude Code style
workflows without inventing a published marketplace package.

## What is here

- `.claude/commands/codeflow-proof.md`: a slash-command style playbook
- `.claude/agents/codeflow-reviewer.md`: a focused reviewer/subagent prompt
...
- `../plugin-bundles/codeflow-coding-agent-bundle/`: a local plugin-dir
...
2. Copy `project.mcp.json` into your project root as `.mcp.json`, or use
   ...
   replace `__CODEFLOW_REPO_ROOT__`.
...
- the copied `.claude/commands/codeflow-proof.md` playbook routes you back to
